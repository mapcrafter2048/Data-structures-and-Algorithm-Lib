...
/*
    * so in this question we can do the traditonal apprach that is
    * when we find a zero we can make the row and column zero
    * becasue that will eventually make a the matrix 0
    * to prevent this we will keep a trach of the corresponding row and column
    * and then we will make the row and column zero
